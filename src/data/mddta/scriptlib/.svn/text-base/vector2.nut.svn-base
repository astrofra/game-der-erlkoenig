...
class 	Vector2
{
	...
	function	AddReal(k)		{	return Vector2(x + k, y + k);		}
	function	SubReal(k)		{	return Vector2(x - k, y - k);		}
	function	MulReal(k)		{	return Vector2(x * k, y * k);		}
	function	DivReal(k)		{	local i = 1.0 / k; return Vector2(x * i, y * i);		}
